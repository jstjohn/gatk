package public.scala.qscript.greenlab
...
import org.broadinstitute.sting.queue.extensions.picard.{AddOrReplaceReadGroups, ReorderSam, SortSam}
...
class ReScaffoldAssemblyPipeline extends QScript {
  ...
  @Input(doc = "The path to the binary of bwa to align fasta/fastq files", fullName = "path_to_bwa", shortName = "bwa", required = true)
  var bwaPath: File = _

  @Input(doc = "The path to the binary of sga to perform rescaffolding and fasta generation", fullName = "path_to_sga", shortName = "sga", required = true)
  var sgaPath: File = _
